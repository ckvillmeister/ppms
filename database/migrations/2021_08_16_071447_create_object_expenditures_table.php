...
class CreateObjectExpendituresTable extends Migration
{
    ...
    public function up()
    {
        ...
        $inputs = [
                    ...
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - Buildings & Other Structures (Public Market)', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - Machinery & Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - IT Equipment & Software', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - Communication Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - Construction & Heavy Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Repair and Maintenance - Motor Vehicles', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Office Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Information & Communication Technology Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                ];
