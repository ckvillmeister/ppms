...
class CreateObjectExpendituresTable extends Migration
{
    ...
    public function up()
    {
        ...
        $inputs = [
                    ...
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Books', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 1, 'obj_exp_name' => 'Chemical and Filtering Supplies Expenses', 'createdby' => 1, 'datecreated' => $datenow],
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Disaster Response and Rescue Equipment', 'createdby' => 1, 'datecreated' => $datenow],
                    ...
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Furniture and Fixtures', 'createdby' => 1, 'datecreated' => $datenow],
                    ...
                    ['class_exp_id' => 2, 'obj_exp_name' => 'School Buildings', 'createdby' => 1, 'datecreated' => $datenow],
                    ...
                    ['class_exp_id' => 2, 'obj_exp_name' => 'Technical & Scientific Equipment', 'createdby' => 1, 'datecreated' => $datenow],
