...
<div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="row m-3">
        <div class="col-sm-12">
            <button class="btn btn-sm btn-success" id="newRole"><i class="fas fa-plus mr-2"></i>New Role</button>
...
<div class="modal fade" id="modal_new_role" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header card-primary card-outline">
        <h5 class="modal-title" id="modal_title">Role Form</h5>
